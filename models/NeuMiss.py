...
from torch.nn import Linear, Parameter, ReLU, Sequential, Dropout
...
class NeuMissMLP(nn.Module):
    ...
    def __init__(self, n_features: int, neumiss_depth: int, mlp_depth: int,output_dimension: int,
        ...
        self.layers = Sequential(
            ...
            *[Linear(n_features, mlp_width, dtype=dtype), ReLU(), Dropout(p=0.4)]*b,
            *[Linear(mlp_width, mlp_width, dtype=dtype), ReLU(), Dropout(p=0.4)]*b*(mlp_depth-1),
            *[Linear(last_layer_width, output_dimension, dtype=dtype)],
        )
