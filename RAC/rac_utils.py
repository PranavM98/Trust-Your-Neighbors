...
def graph_creation(all_embeddings, all_labels, train_mask, val_mask, test_mask):
...
def graph_preprocessing(folder):
    ...
    return graph_creation(all_embeddings, all_labels, train_mask, val_mask, test_mask)
